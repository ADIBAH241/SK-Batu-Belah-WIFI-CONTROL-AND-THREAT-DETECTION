...
$site = $_SESSION['teacher_last_site'] ?? 'website';
$url = $_SESSION['teacher_last_url'] ?? '';
$result = $_SESSION['teacher_last_result'] ?? 'allowed';
$message = $_SESSION['teacher_last_message'] ?? 'Website allowed.';
?>
<!DOCTYPE html>
<html>
<head>
<title>Teacher Access Status</title>
<style>
...
<div class="box">
    ...
    <br>
    <button class="back" onclick="window.location.href='browse_internet_teacher.php'">Back</button>
