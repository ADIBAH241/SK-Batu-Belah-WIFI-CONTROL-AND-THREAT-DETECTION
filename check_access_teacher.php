...
if($website == ''){
    header("Location: browse_internet_teacher.php");
    exit();
}
...
$_SESSION['teacher_last_site'] = $host;
$_SESSION['teacher_last_url'] = $url;
$_SESSION['teacher_last_result'] = $result;
$_SESSION['teacher_last_message'] = $message;

header("Location: access_continue_teacher.php");
exit();
?>
